...
<html lang="en">
  ...
  <body style="margin:0;background-color:#f3f4f6;font-family:Arial, Helvetica, sans-serif;color:#111;">
      ...
      <tr>
        <td align="center">
          <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 6px 18px rgba(16,24,40,0.08);">
            <tr>
              <td style="padding:24px 28px;background: linear-gradient(90deg,#dc2626,#f97316); color:#ffffff;">
                ...
                <p style="margin:6px 0 0;font-size:13px;opacity:0.95;">
                  Cancelled by ${escapeHtml(organizerName)}
                </p>
              </td>
            </tr>
            <tr>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    <td style="padding-bottom:12px;">
                      <strong style="display:block;font-size:14px;margin-bottom:6px;color:#0f172a;">Scheduled Time</strong>
    ...
    endTime ? ` — ${escapeHtml(endTime)}` : ""
                  ...
                  <tr>
                    <td style="padding-bottom:12px;">
                      <strong style="display:block;font-size:14px;margin-bottom:6px;color:#0f172a;">Original Location</strong>
                      <div style="font-size:14px;color:#374151;">
                  ...
                  <tr>
                    <td style="padding-top:18px;padding-bottom:8px;">
                      <a href="${encodeURI(
                        viewUrl
                      )}" style="display:inline-block;padding:10px 16px;border-radius:8px;background:#f3f4f6;border:1px solid #e6e9ef;color:#374151;text-decoration:none;font-weight:600;font-size:14px;">
                        View Calendar
                      </a>
                    </td>
                  </tr>
                  <tr>
                    <td style="padding-top:20px;border-top:1px solid #fee2e2;">
                      <p style="margin:0;font-size:12px;color:#6b7280;">
                        This event has been cancelled. Please remove it from your schedule.
                      </p>
    ...
    location || "merndev.site"
            ...
            <tr>
              <td style="padding:14px 20px;background:#fafafa;font-size:12px;color:#9ca3af;text-align:center;">
                <div>Need help? Contact <a href="mailto:support@merndev.site" style="color:#dc2626;text-decoration:none;">support@merndev.site</a></div>
              </td>
            </tr>
          </table>
        </td>
